...
![A dial with three regions. Left: an adult cell doing its job. Middle, in blue: a partial reset, where age markers are cleared but the cell is still a skin cell, achieved by Ocampo's cyclic bursts of two days on and five days off. Right, in red: identity erased entirely, which is what Abad's continuous expression produced, ending in teratomas. The caption notes that the boundary between the blue and red regions is not a line but a dose, since Ocampo's own cyclic protocol still produced teratomas in mice carrying two copies of the factors.](reprogramming-window.svg)
...
![A chart plotting five results against how far each reaches: cells, tissue, organ function, whole animal. Abad 2013, in normal mice with the factors left on, reaches the whole animal with teratomas. Ocampo 2016 in progeria mice reaches the whole animal with extended lifespan. Ocampo 2016 in normal aged mice reaches only tissue, with improved injury recovery. Browder 2022 in normal aged mice reaches only tissue, with improved tissue and clock markers. Lu 2020 in aged and glaucoma mice reaches organ function, with vision restored. The only lifespan win is in mice bred to age abnormally fast.](what-has-been-shown.svg)
...
- Takahashi, K. and Yamanaka, S. (2006). [Induction of pluripotent stem cells from mouse embryonic and adult fibroblast cultures by defined factors](https://doi.org/10.1016/j.cell.2006.07.024). *Cell* 126, 663–676.
- Horvath, S. (2013). [DNA methylation age of human tissues and cell types](https://doi.org/10.1186/gb-2013-14-10-r115). *Genome Biology* 14, R115.
- Abad, M. et al. (2013). [Reprogramming in vivo produces teratomas and iPS cells with totipotency features](https://doi.org/10.1038/nature12586). *Nature* 502, 340–345.
- Ocampo, A. et al. (2016). [In vivo amelioration of age-associated hallmarks by partial reprogramming](https://doi.org/10.1016/j.cell.2016.11.052). *Cell* 167, 1719–1733.
